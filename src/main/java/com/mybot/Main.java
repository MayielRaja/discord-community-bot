        ...
        public class Main {
            public static void main(String[] args) throws InterruptedException {
                // PASTE YOUR NEW, RESET TOKEN HERE
                String token = "MTQxNzUxNDE0MjMxODk4OTMyMg.GAcNUZ.yEO2BiYpQ4TiiP4fgKOgADMHK43cZhON0Vtvxg";
                String serverId = "1417513571650371687";
